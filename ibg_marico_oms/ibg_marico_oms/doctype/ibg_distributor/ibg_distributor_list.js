frappe.listview_settings["IBG Distributor"] = {
    ...
    refresh: function (listview) {
        ...
        if (is_true || frappe.session.user == "Administrator") {
            listview.page.add_menu_item(__("Download Distributor Template"), function () {
            frappe.call({
                method:
                "ibg_marico_oms.ibg_marico_oms.doctype.ibg_distributor.ibg_distributor.distributor_template",
                freeze: true,
                callback: (res) => {
        ...
        if (is_true || frappe.session.user == "Administrator") { 
        listview.page.add_menu_item(__("Upload Distributor File"), function () {
            ...
            primary_action(values) {
                ...
                // }
                frappe.call({
                method: "ibg_marico_oms.ibg_marico_oms.doctype.ibg_distributor.ibg_distributor.distributor_file_upload",
                args: {
